...
# FV3 executable:
cp ${PATHRT}/../NEMS/exe/NEMS.x                                 fv3.exe

# modulefile for FV3 prerequisites:
cp ${PATHRT}/modules.fcst             modules.fcst
...
#####Copy restarts to f2RT by JZ
mkdir -p ${RTPWD}/S2S_RT_rst/fcst_${SYEAR}/${TEST_NAME}${RT_SUFFIX}
cp -rHp ${RUNDIR}/RESTART ${RTPWD}/S2S_RT_rst/fcst_${SYEAR}/${TEST_NAME}${RT_SUFFIX}/
cp -rHp ${RUNDIR}/ufs.s2s*.nc ${RTPWD}/S2S_RT_rst/fcst_${SYEAR}/${TEST_NAME}${RT_SUFFIX}/ 
cp -rHp ${RUNDIR}/rpointer.cpl ${RTPWD}/S2S_RT_rst/fcst_${SYEAR}/${TEST_NAME}${RT_SUFFIX}/ 
################################
