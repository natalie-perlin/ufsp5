# 1 "/lustre/f2/dev/ncep/JieShun.Zhu/ufsp5/ufs-s2s-model_zbotC5/FV3/ccpp/physics/physics/sfc_sice.f"
!>  \file sfc_sice.f
!!  This file contains the GFS three level thermodynamic sea ice model.

!> This module contains the 1-compliant GFS sea ice scheme.
      module sfc_sice
...
!>  @{
     ...
     &     ( im, kice, sbc, hvap, tgice, cp, eps, epsm1, rvrdm1, grav,  
...
! - Define constant parameters
      ...
      real(kind=kind_phys), parameter :: zero  = 0.0_kind_phys, one = 1.
