# 1 "/lustre/f2/dev/ncep/JieShun.Zhu/ufsp5/ufs-s2s-model_zbotC5/FV3/ccpp/physics/physics/sfc_noahmp_drv.f"
...
!> This module contains the 1-compliant NoahMP land surface model driver.
      module noahmpdrv
...
!> \ingroup NoahMP_LSM
!! \brief This subroutine is called during the 1 initialization phase and calls set_soilveg() to
...
!> \ingroup NoahMP_LSM
!! \brief This subroutine is the main 1 entry point for the NoahMP LSM.
...
!           stsoil(k) = stc(i,k)
     ...
     &   iopt_inf ,iopt_rad ,iopt_alb ,iopt_snf ,iopt_tbot, iopt_stc )
       ...
       call noahmp_glacier (                                            
     &             i       ,1       ,cosz    ,nsnow   ,nsoil   ,delt  , 
     &             sfctmp  ,sfcprs  ,uu      ,vv      ,q2      ,swdn  , 
     &             prcp    ,lwdn    ,tbot    ,zlvl    ,ficeold ,zsoil , 
     &             qsnowx  ,sneqvox ,alboldx ,cmx     ,chx     ,isnowx, 
     &             swe  ,smsoil  ,zsnsox     ,snowh  ,snicex ,snliqx ,  
     &             tgx     ,tsnsox  ,slsoil  ,taussx  ,qsfc1d         , 
     &             fsa     ,fsr     ,fira    ,fsh     ,fgev  ,ssoil   , 
     &             trad    ,edir    ,runsrf  ,runsub  ,sag   ,albedo  , 
     &             qsnbot  ,ponding ,ponding1,ponding2,t2mb  ,q2b     , 
...
!        write(*,*)'tsnsox(1)=',tsnsox,'tgx=',tgx
     ...
     &        i       , 1       , lat     , iyrlen  , julian  , cosz   ,
     &        delt    , dx      , dz8w    , nsoil   , zsoil   , nsnow  ,
     &        shdfac  , shdmax1d, vtype   , ice     , ist              ,
     &        smoiseqx                                                 ,
     &        sfctmp  , sfcprs  , psfc    , uu      , vv      , q2     ,
     &        qc      , swdn    , lwdn                                 ,
     &        pconv   , pnonc   , pshcv   , psnow   , pgrpl   , phail  ,
     &        tbot    , co2pp   , o2pp    , foln    , ficeold , zlvl   ,
     &        alboldx , sneqvox                                        ,
     &        tsnsox  , slsoil  , smsoil  , tahx    , eahx    , fwetx  ,
     &        canliqx , canicex , tvx     , tgx     , qsfc1d  , qsnowx ,
     &        isnowx  , zsnsox  , snowh   , swe     , snicex  , snliqx ,
     &        zwtx    , wax     , wtx     , wslakex , lfmassx , rtmassx,
     &        stmassx , woodx   , stblcpx , fastcpx , xlaix   ,xsaix   ,
     &        cmx     , chx     , taussx                               ,
     &        smcwtdx ,deeprechx, rechx                                ,
     &        z0wrf                                                    ,
...
! ----------------------------------------------------------------------
     ...
     &                           t2v, th2,emissi_in,sncovr
      ...
      real, parameter :: elcp = 2.4888e+3, lsubc = 2.501000e+6,cp = 1004
