# 1 "/lustre/f2/dev/ncep/JieShun.Zhu/ufsp5/ufs-s2s-model_zbotC5/FV3/ccpp/physics/physics/gwdc.f"
...
!> This module contains the 1-compliant convective gravity
...
!> This module contains the 1-compliant
...
!! \f]
            ...
            if (k < kk .and. k > 1) then
              if ( abs(taugwci(i,k+1)) > taumin ) then                  
                if ( riloc(i,k) > ricrit ) then                         
                  if ( rimin(i,k) > ricrit ) then                       
...
!> This module contains the 1-compliant convective gravity wave
