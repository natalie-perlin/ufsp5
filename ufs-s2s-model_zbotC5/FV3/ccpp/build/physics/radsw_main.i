# 1 "/lustre/f2/dev/ncep/JieShun.Zhu/ufsp5/ufs-s2s-model_zbotC5/FV3/ccpp/physics/physics/radsw_main.f"
!>  \file radsw_main.f
...
!> This module contains the 1-compliant NCEP's modifications of the rrtm-sw radiation
!! code from aer inc.
      module rrtmg_sw 
!
...
!-----------------------------------
     ...
     &       gasvmr_cfc11,gasvmr_cfc12,gasvmr_cfc22,gasvmr_ccl4,        
...
!ncep model use
            h2ovmr(k)= max(f_zero,qlyr(j1,kk)*amdw/(f_one-qlyr(j1,kk))) 
            o3vmr (k)= max(f_zero,olyr(j1,kk)*amdo3)                    
