# 1 "/lustre/f2/dev/ncep/JieShun.Zhu/ufsp5/ufs-s2s-model_zbotC5/FV3/ccpp/physics/physics/num_parthds.F"
      function num_parthds()

# 1 "/opt/intel/oneapi/compiler/2022.2.1/linux/bin/intel64/../../compiler/include/omp_lib.h" 1 
! <copyright>
!
...
! </copyright>
      ...
      parameter(kmp_version_build=20220623)
      character(*)kmp_build_date
      parameter(kmp_build_date='2022-07-08 20:31:59 UTC')
...
!DIR$ ENDIF
!DIR$ ENDIF
# 4 "/lustre/f2/dev/ncep/JieShun.Zhu/ufsp5/ufs-s2s-model_zbotC5/FV3/ccpp/physics/physics/num_parthds.F" 2 
!$OMP PARALLEL
