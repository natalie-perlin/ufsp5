...
!!
!
module ccpp_FV3_GFS_2017_coupled_stochastics_cap
   ...
   private
   public :: FV3_GFS_2017_coupled_stochastics_init_cap, &
             FV3_GFS_2017_coupled_stochastics_run_cap, &
             FV3_GFS_2017_coupled_stochastics_finalize_cap

   logical, save :: initialized = .false.

   contains

   function FV3_GFS_2017_coupled_stochastics_init_cap() result(ierr)
   ...
   end function FV3_GFS_2017_coupled_stochastics_init_cap

   function FV3_GFS_2017_coupled_stochastics_run_cap(cdata,GFS_Data,GFS_Control) result(ierr)
   ...
   end function FV3_GFS_2017_coupled_stochastics_run_cap

   function FV3_GFS_2017_coupled_stochastics_finalize_cap() result(ierr)
   ...
   end function FV3_GFS_2017_coupled_stochastics_finalize_cap

end module ccpp_FV3_GFS_2017_coupled_stochastics_cap
