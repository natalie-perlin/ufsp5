...
!!
!
module ccpp_FV3_GFS_2017_satmedmf_coupled_cap
   ...
   private
   public :: FV3_GFS_2017_satmedmf_coupled_init_cap, &
             FV3_GFS_2017_satmedmf_coupled_run_cap, &
             FV3_GFS_2017_satmedmf_coupled_finalize_cap

   contains

   function FV3_GFS_2017_satmedmf_coupled_init_cap(cdata,GFS_Interstitial,GFS_Control,GFS_Data,con_p0) result(ierr)
   ...
   end function FV3_GFS_2017_satmedmf_coupled_init_cap

   function FV3_GFS_2017_satmedmf_coupled_run_cap(con_sbc,con_t0c,con_rd,LTP,con_eps,con_hvap,con_cliq,GFS_Data,con_g,con_pi, &
                  cimin,con_epsm1,GFS_Interstitial,huge,con_hfus,con_cp,cdata,GFS_Control, &
                  con_cvap,con_rv,con_fvirt,con_tice) result(ierr)
   ...
   end function FV3_GFS_2017_satmedmf_coupled_run_cap

   function FV3_GFS_2017_satmedmf_coupled_finalize_cap(cdata) result(ierr)
   ...
   end function FV3_GFS_2017_satmedmf_coupled_finalize_cap

end module ccpp_FV3_GFS_2017_satmedmf_coupled_cap
