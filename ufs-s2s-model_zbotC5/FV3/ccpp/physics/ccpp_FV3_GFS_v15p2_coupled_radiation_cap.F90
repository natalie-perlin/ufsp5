...
!!
!
module ccpp_FV3_GFS_v15p2_coupled_radiation_cap
   ...
   private
   public :: FV3_GFS_v15p2_coupled_radiation_init_cap, &
             FV3_GFS_v15p2_coupled_radiation_run_cap, &
             FV3_GFS_v15p2_coupled_radiation_finalize_cap

   logical, save :: initialized = .false.

   contains

   function FV3_GFS_v15p2_coupled_radiation_init_cap() result(ierr)
   ...
   end function FV3_GFS_v15p2_coupled_radiation_init_cap

   function FV3_GFS_v15p2_coupled_radiation_run_cap(cdata,GFS_Interstitial,GFS_Data,GFS_Control,LTP) result(ierr)
   ...
   end function FV3_GFS_v15p2_coupled_radiation_run_cap

   function FV3_GFS_v15p2_coupled_radiation_finalize_cap() result(ierr)
   ...
   end function FV3_GFS_v15p2_coupled_radiation_finalize_cap

end module ccpp_FV3_GFS_v15p2_coupled_radiation_cap
