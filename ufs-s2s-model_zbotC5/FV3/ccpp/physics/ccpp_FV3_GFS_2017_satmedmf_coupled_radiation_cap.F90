...
!!
!
module ccpp_FV3_GFS_2017_satmedmf_coupled_radiation_cap
   ...
   private
   public :: FV3_GFS_2017_satmedmf_coupled_radiation_init_cap, &
             FV3_GFS_2017_satmedmf_coupled_radiation_run_cap, &
             FV3_GFS_2017_satmedmf_coupled_radiation_finalize_cap

   logical, save :: initialized = .false.

   contains

   function FV3_GFS_2017_satmedmf_coupled_radiation_init_cap() result(ierr)
   ...
   end function FV3_GFS_2017_satmedmf_coupled_radiation_init_cap

   function FV3_GFS_2017_satmedmf_coupled_radiation_run_cap(cdata,GFS_Interstitial,GFS_Data,GFS_Control,LTP) result(ierr)
      ...
      call GFS_rrtmg_pre_run(Model=GFS_Control,Grid=GFS_Data(cdata%blk_no)%Grid,Sfcprop=GFS_Data(cdata%blk_no)%Sfcprop, &
                  ...
                  f_ice=GFS_Interstitial(cdata%thrd_no)%f_ice,f_rain=GFS_Interstitial(cdata%thrd_no)%f_rain, &
                  f_rimef=GFS_Interstitial(cdata%thrd_no)%f_rimef,flgmin=GFS_Control%flgmin, &
                  cwm=GFS_Interstitial(cdata%thrd_no)%cwm,lm=GFS_Control%levr,im=GFS_Control%blksz(cdata%blk_no), &
                  ...
                  imfdeepcnv=GFS_Control%imfdeepcnv,imfdeepcnv_gf=GFS_Control%imfdeepcnv_gf, &
                  ...
                  de_lgth=GFS_Interstitial(cdata%thrd_no)%de_lgth,alb1d=GFS_Interstitial(cdata%thrd_no)%alb1d, &
      ...
      call rrtmg_sw_post_run(Model=GFS_Control,Grid=GFS_Data(cdata%blk_no)%Grid,Diag=GFS_Data(cdata%blk_no)%Intdiag, &
                  ...
                  lm=GFS_Control%levr,kd=GFS_Interstitial(cdata%thrd_no)%kd,htswc=GFS_Interstitial(cdata%thrd_no)%htswc, &
                  htsw0=GFS_Interstitial(cdata%thrd_no)%htsw0,sfcalb1=GFS_Interstitial(cdata%thrd_no)%sfcalb(:,1), &
                  sfcalb2=GFS_Interstitial(cdata%thrd_no)%sfcalb(:,2),sfcalb3=GFS_Interstitial(cdata%thrd_no)%sfcalb(:,3), &
                  sfcalb4=GFS_Interstitial(cdata%thrd_no)%sfcalb(:,4),scmpsw=GFS_Interstitial(cdata%thrd_no)%scmpsw, &
                  errmsg=cdata%errmsg,errflg=cdata%errflg)
      ...
      call rrtmg_lw_post_run(Model=GFS_Control,Grid=GFS_Data(cdata%blk_no)%Grid,Radtend=GFS_Data(cdata%blk_no)%Radtend, &
                  ...
                  ltp=LTP,lm=GFS_Control%levr,kd=GFS_Interstitial(cdata%thrd_no)%kd,tsfa=GFS_Interstitial(cdata%thrd_no)%tsfa, &
                  htlwc=GFS_Interstitial(cdata%thrd_no)%htlwc,htlw0=GFS_Interstitial(cdata%thrd_no)%htlw0, &
                  errmsg=cdata%errmsg,errflg=cdata%errflg)
      ...
      call GFS_rrtmg_post_run(Model=GFS_Control,Grid=GFS_Data(cdata%blk_no)%Grid,Diag=GFS_Data(cdata%blk_no)%Intdiag, &
                  ...
                  im=GFS_Control%blksz(cdata%blk_no),lm=GFS_Control%levr,ltp=LTP,kt=GFS_Interstitial(cdata%thrd_no)%kt, &
                  kb=GFS_Interstitial(cdata%thrd_no)%kb,kd=GFS_Interstitial(cdata%thrd_no)%kd, &
                  raddt=GFS_Interstitial(cdata%thrd_no)%raddt,aerodp=GFS_Interstitial(cdata%thrd_no)%aerodp, &
                  ...
                  nday=GFS_Interstitial(cdata%thrd_no)%nday,errmsg=cdata%errmsg,errflg=cdata%errflg)
   ...
   end function FV3_GFS_2017_satmedmf_coupled_radiation_run_cap

   function FV3_GFS_2017_satmedmf_coupled_radiation_finalize_cap() result(ierr)
   ...
   end function FV3_GFS_2017_satmedmf_coupled_radiation_finalize_cap

end module ccpp_FV3_GFS_2017_satmedmf_coupled_radiation_cap
