...
!!
!
module ccpp_FV3_GFS_2017_coupled_physics_cap
   ...
   private
   public :: FV3_GFS_2017_coupled_physics_init_cap, &
             FV3_GFS_2017_coupled_physics_run_cap, &
             FV3_GFS_2017_coupled_physics_finalize_cap

   logical, save :: initialized = .false.

   contains

   function FV3_GFS_2017_coupled_physics_init_cap(con_p0,cdata,GFS_Control) result(ierr)
   ...
   end function FV3_GFS_2017_coupled_physics_init_cap

   function FV3_GFS_2017_coupled_physics_run_cap(con_sbc,con_pi,GFS_Control,GFS_Data,con_cliq,con_epsm1,con_hvap,GFS_Interstitial, &
   ...
   end function FV3_GFS_2017_coupled_physics_run_cap

   function FV3_GFS_2017_coupled_physics_finalize_cap(cdata) result(ierr)
   ...
   end function FV3_GFS_2017_coupled_physics_finalize_cap

end module ccpp_FV3_GFS_2017_coupled_physics_cap
