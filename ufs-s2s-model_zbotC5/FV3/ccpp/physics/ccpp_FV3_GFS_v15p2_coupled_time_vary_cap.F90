...
!!
!
module ccpp_FV3_GFS_v15p2_coupled_time_vary_cap
   ...
   private
   public :: FV3_GFS_v15p2_coupled_time_vary_init_cap, &
             FV3_GFS_v15p2_coupled_time_vary_run_cap, &
             FV3_GFS_v15p2_coupled_time_vary_finalize_cap

   logical, save :: initialized = .false.

   contains

   function FV3_GFS_v15p2_coupled_time_vary_init_cap(GFS_Interstitial,cdata,GFS_Data,GFS_Control) result(ierr)
   ...
   end function FV3_GFS_v15p2_coupled_time_vary_init_cap

   function FV3_GFS_v15p2_coupled_time_vary_run_cap(cdata,GFS_Data,GFS_Control) result(ierr)
   ...
   end function FV3_GFS_v15p2_coupled_time_vary_run_cap

   function FV3_GFS_v15p2_coupled_time_vary_finalize_cap(cdata) result(ierr)
   ...
   end function FV3_GFS_v15p2_coupled_time_vary_finalize_cap

end module ccpp_FV3_GFS_v15p2_coupled_time_vary_cap
