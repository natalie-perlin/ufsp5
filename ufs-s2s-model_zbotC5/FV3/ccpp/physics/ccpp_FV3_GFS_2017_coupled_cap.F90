...
!!
!
module ccpp_FV3_GFS_2017_coupled_cap
   ...
   private
   public :: FV3_GFS_2017_coupled_init_cap, &
             FV3_GFS_2017_coupled_run_cap, &
             FV3_GFS_2017_coupled_finalize_cap

   contains

   function FV3_GFS_2017_coupled_init_cap(cdata,GFS_Interstitial,GFS_Control,GFS_Data,con_p0) result(ierr)
   ...
   end function FV3_GFS_2017_coupled_init_cap

   function FV3_GFS_2017_coupled_run_cap(cimin,con_tice,con_t0c,GFS_Data,GFS_Control,huge,con_epsm1,con_cliq,GFS_Interstitial, &
                  con_rd,con_hvap,con_rv,con_g,con_cp,con_cvap,LTP,con_fvirt,con_pi,cdata, &
                  con_eps,con_sbc) result(ierr)
   ...
   end function FV3_GFS_2017_coupled_run_cap

   function FV3_GFS_2017_coupled_finalize_cap(cdata) result(ierr)
   ...
   end function FV3_GFS_2017_coupled_finalize_cap

end module ccpp_FV3_GFS_2017_coupled_cap
