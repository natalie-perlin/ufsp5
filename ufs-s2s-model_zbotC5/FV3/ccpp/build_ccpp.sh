...
export ESMFMKFILE=/lustre/f2/pdata/ncep/Weiyu.Yang/ESMF/esmf_8_1_0bs27/esmf/lib/libO/Unicos.intel.64.mpi.default/esmf.mk
export ESMF_LIB=/lustre/f2/pdata/ncep/Weiyu.Yang/ESMF/esmf_8_1_0bs27/esmf/lib/libO/Unicos.intel.64.mpi.default/libesmf.a
export ESMF_F90COMPILEPATHS=/lustre/f2/pdata/ncep/Weiyu.Yang/ESMF/esmf_8_1_0bs27/esmf/mod/modO/Unicos.intel.64.mpi.default
...
if [[ "${MACHINE_ID}" == "macosx.gnu" ]]; then
  ...
  export LIBXML2_LIB_DIR=/lustre/f2/pdata/ncep_shared/NCEPLIBS/l1013/lib/xml2
  export LIBXML2_INCLUDE_DIR=/lustre/f2/pdata/ncep_shared/NCEPLIBS/l1013/lib/xml2/include
