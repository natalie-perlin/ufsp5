...
HDF5=/gpfs/hps/usrx/local/prod/HDF5/1.8.9/serial/intel/sandybridge
...
FFLAGS += $(NETCDF_INCLUDE)  ##-I/usrx/local/NetCDF/4.2/serial/include
CFLAGS += $(NETCDF_INCLUDE)  ##-I/usrx/local/NetCDF/4.2/serial/include
